...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        string dbPath = $@"F:\\src\\DuckDB.NET\\MemoryExceptionCode\\database_{timestamp}.db";
        string jsonFilePath = @"F:\\src\\DuckDB.NET\\MemoryExceptionCode\\scanned_files_dump.json";
